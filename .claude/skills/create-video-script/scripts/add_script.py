...
示例:
    python scripts/add_script.py 1 "陈书文" "你好，请问这里有人吗？" "期待"
    python scripts/add_script.py 1 "现代女孩" "没人，你坐吧。" "随意"
    python scripts/add_script.py 2 "陈书文" "谢谢。" "感激"
"""
...
def main():
    ...
    if not args.skip_verify:
        ...
        if args.character not in registered_chars:
            print(
                f"❌ 角色 '{args.character}' 未在分镜 {args.shot} 的 stage.json 登场角色中声明。\n"
    ...
    print(f"✅ 分镜 {args.shot} 已添加台词（共 {len(data)} 条）")
