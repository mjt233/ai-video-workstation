...
示例:
    python scripts/add_stage.py -e 1 1 "现代商场/现代商场-白天-平视-晴-中央扶梯" "陈书文" "图像1为背景：现代商场中央扶梯；图像2为陈书文：年轻女性...；陈书文在扶梯前驻足张望。"
    python scripts/add_stage.py -e 1 2 "现代商场/现代商场-白天-平视-晴-奶茶店前" "陈书文,现代女孩" "图像1...；图像2为陈书文...；图像3为现代女孩..."
