<template>
  <v-row class="ma-0" style="height: calc(100vh - 64px); overflow: hidden;">
    <v-col cols="3" class="pa-2 border-e bg-surface" style="overflow-y: auto; height: 100%;">
    ...
    <v-col cols="9" class="pa-4" style="overflow-y: auto; height: 100%;">
